...
Module.register('MMM-Scenes2', {
  ...
  start: function () {
    ...
    // ─── Last.fm listener setup ─────────────────────────────────────────────
    // register this module with the shared Fetcher
    this.sendNotification("REGISTER_LISTENER", this.name)
    this.sendNotification("FETCHER_ADD_LISTENER", this.name)
    // ─────────────────────────────────────────────────────────────────────────
