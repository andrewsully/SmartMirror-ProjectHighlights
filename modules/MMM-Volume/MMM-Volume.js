...
Module.register("MMM-Volume", {
  defaults: {
    ...
    usePresetScript: "PULSE", // null or "OSX" or "ALSA", When set to `null`, `getVolumeScript` and `setVolumeScript` will be used directly.
  ...
  drawVolume: function(current, old) {
    ...
    setTimeout(()=>{
      if (container) { // Check again before hiding
