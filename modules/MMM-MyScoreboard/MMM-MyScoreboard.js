...
Module.register('MMM-MyScoreboard', {
  ...
  getScores: function () {
    ...
    this.config.sports.forEach(function (sport, index) {
      ...
      if (isNFL) {
        // For NFL, use week-based logic
        // NFL weeks typically start on Tuesday and end on Monday
        // Get the current NFL week (Tuesday to Monday)
        ...
        // For NFL, "today" means current week, "yesterday" means previous week
